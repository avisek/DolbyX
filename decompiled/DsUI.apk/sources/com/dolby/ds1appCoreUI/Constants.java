...
public class Constants {
    ...
    public static final float MAX_VISIBLE_GAIN = 36.0f;
    public static final float MIN_VISIBLE_GAIN = -12.0f;
    public static final int PREDEFINED_PROFILE_COUNT = 4;
    public static final int PROFILE_CUSTOM1_INDEX = 5;
    public static final int PROFILE_CUSTOM2_INDEX = 6;
    public static final float VISIBLE_GAIN_SPAN = 48.0f;
